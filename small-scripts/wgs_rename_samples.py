...
# Adding arguments
parser.add_argument(
    "-i", "--input", help="Bioinformatics samplesheet or samples_and_settings.json generated by Stackstorm defining workpackages, experiment, analysis etc.", required=True
)
